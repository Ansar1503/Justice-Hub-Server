...
export async function setUpChatSocket(io: SocketIOServer) {
    io.on("connection", (socket: Socket) => {
        ...
        // join listener
        socket.on(SocketEventEnum.JOIN_CHAT_EVENT, async (data: { sessionId: string }) => {
        ...
        // typing listener
        socket.on(SocketEventEnum.TYPING_EVENT, (data: { session_id: string; userId: string }) => {
        ...
        socket.on(SocketEventEnum.SEND_MESSAGE_EVENT, async (data: ChatMessageInputDto, cb: any) => {
        ...
        socket.on(SocketEventEnum.MESSAGE_DELETE_EVENT, (data: { messageId: string; sessionId: string }) => {
