...
exports.UploadCaseDocumentsController = void 0;
class UploadCaseDocumentsController {
    _CaseDocumentUpload;
    _errors;
    _success;
    constructor(_CaseDocumentUpload, _errors, _success) {
        this._CaseDocumentUpload = _CaseDocumentUpload;
    ...
    async handle(httpRequest) {
        ...
        if (httpRequest.file && typeof httpRequest.file === "object") {
            if ("mimetype" in httpRequest.file &&
...
exports.UploadCaseDocumentsController = UploadCaseDocumentsController;
