...
exports.VerifyLawyerController = void 0;
const HttpSuccess_1 = require("@interfaces/helpers/implementation/HttpSuccess");
const HttpErrors_1 = require("@interfaces/helpers/implementation/HttpErrors");
class VerifyLawyerController {
    verifyLawyer;
    httpSuccess;
    httpErrors;
    constructor(verifyLawyer, httpSuccess = new HttpSuccess_1.HttpSuccess(), httpErrors = new HttpErrors_1.HttpErrors()) {
        this.verifyLawyer = verifyLawyer;
    ...
    async handle(httpRequest) {
        ...
        if (httpRequest.files &&
            ...
            DocumentsPayload.enrollment_certificate = httpRequest.files.enrollment_certificate[0]?.path;
        }
        if (httpRequest.files &&
            typeof httpRequest.files === "object" &&
            ...
            DocumentsPayload.certificate_of_practice = httpRequest.files.certificate_of_practice[0]?.path;
        }
        if (httpRequest.files &&
            typeof httpRequest.files === "object" &&
            ...
            DocumentsPayload.bar_council_certificate = httpRequest.files.barcouncilid[0].path;
        }
        if (httpRequest.body && typeof httpRequest.body === "object") {
            ...
            if ("barcouncil_number" in httpRequest.body) {
                LawyersPayload.barcouncil_number = String(httpRequest.body.barcouncil_number);
            }
            if ("enrollment_certificate_number" in httpRequest.body) {
                LawyersPayload.enrollment_certificate_number = String(httpRequest.body.enrollment_certificate_number);
            }
            if ("certificate_of_practice_number" in httpRequest.body) {
                LawyersPayload.certificate_of_practice_number = String(httpRequest.body.certificate_of_practice_number);
            }
            if ("practice_areas" in httpRequest.body && Array.isArray(httpRequest.body.practice_areas)) {
            ...
            if ("specialisation" in httpRequest.body && Array.isArray(httpRequest.body.specialisation)) {
                LawyersPayload.specialisation = httpRequest.body.specialisation;
            }
            if ("consultation_fee" in httpRequest.body) {
                LawyersPayload.consultation_fee = String(httpRequest.body.consultation_fee);
            }
        }
        const documents = {
        ...
        if (!documents.bar_council_certificate ||
        ...
        const payload = {
            ...
            enrollment_certificate_number: LawyersPayload.enrollment_certificate_number,
            certificate_of_practice_number: LawyersPayload.certificate_of_practice_number,
            verification_status: "requested",
            practice_areas: LawyersPayload.practice_areas,
            experience: isNaN(Number(LawyersPayload.experience)) ? 0 : Number(LawyersPayload.experience),
...
exports.VerifyLawyerController = VerifyLawyerController;
