...
export interface IAppointmentsRepository {
    ...
    findByDateandLawyer_id(payload: { lawyer_id: string; date: Date }): Promise<Appointment[] | null>;
    findByDateandClientId(payload: { client_id: string; date: Date }): Promise<Appointment[] | null>;
