...
export interface IWalletTransactionsRepo extends IBaseRepository<WalletTransaction> {
    findTransactionsByWalletId(payload: getWalletTransactionsRepoInputDto): Promise<{
