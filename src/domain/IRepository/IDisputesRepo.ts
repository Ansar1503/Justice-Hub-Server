...
export interface IDisputes {
    ...
    findReviewDisputes(payload: FetchReviewDisputesInputDto): Promise<FetchReviewDisputesOutputDto>;
    findAllChatDisputes(payload: FetchChatDisputesInputDto): Promise<FetchChatDisputesOutputDto>;
    update(payload: {
        disputesId: string;
