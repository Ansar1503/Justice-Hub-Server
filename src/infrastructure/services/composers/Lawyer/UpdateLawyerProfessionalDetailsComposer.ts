...
export function UpdateLawyersProfessionalDetailsComposer(): IController {
    const usecase = new UpdateProfessionalDetailsUsecase(new LawyerRepository(new LawyerMapper()));
    return new UpdateLawyersProfessionalDetails(usecase, new HttpErrors(), new HttpSuccess());
}
