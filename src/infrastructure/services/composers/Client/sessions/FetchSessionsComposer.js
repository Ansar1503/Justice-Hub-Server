...
const FetchSessionsController_1 = require("@interfaces/controller/Client/Sessions/FetchSessionsController");
...
function FetchSessionsComposer() {
    ...
    return new FetchSessionsController_1.FetchSessionController(usecase);
}
