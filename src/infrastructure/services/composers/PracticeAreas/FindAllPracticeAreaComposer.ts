...
export function FindAllPracticeAreaComposer(): IController {
    const usecase = new FindAllpracticeAreasUsecase(new PracticeAreaRepo(new PracticeAreaMapper()));
    return new FindAllPracticeAreasController(usecase, new HttpSuccess(), new HttpErrors());
}
