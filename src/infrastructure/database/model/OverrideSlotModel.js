...
const overrideDateSchema = new mongoose_1.Schema({
    date: { type: Date, required: true },
    isUnavailable: { type: Boolean, required: true },
    timeRanges: [timeSlotSchema],
}, { _id: false });
const overrideSlotSchema = new mongoose_1.Schema({
    _id: { type: String },
    lawyer_id: { type: String, required: true, unique: true },
    overrideDates: [overrideDateSchema],
}, { timestamps: true });
exports.default = mongoose_1.default.model("override_slots", overrideSlotSchema);
