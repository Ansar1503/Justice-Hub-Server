...
exports.BlogRoute = exports.SubscriptionRoute = exports.CommissionRoutes = exports.CasesRoutes = exports.CommonParamsRoute = exports.CasetypeRoutes = exports.PracticeAreaRoutes = exports.SpecializationRoute = exports.WalletRoutes = exports.LawyerRoutes = exports.CallLogsRoute = exports.ClientRoutes = exports.AdminRoutes = exports.AuthRoute = void 0;
exports.AuthRoute = {
    signup: "/signup",
    login: "/login",
    refresh: "/refresh",
...
exports.CallLogsRoute = {
    base: "/calls",
};
exports.LawyerRoutes = {
    base: "/lawyers",
...
exports.SpecializationRoute = {
    base: "/specialization",
    params: "/:id",
};
exports.PracticeAreaRoutes = {
    base: "/practicearea",
    params: "/:id",
};
exports.CasetypeRoutes = {
...
exports.CommissionRoutes = {
    base: "/commission",
    settings: "/settings",
    transactions: "/transactions",
};
exports.SubscriptionRoute = {
    base: "/subscriptions",
    status: "/status",
    subscribe: "/subscibe",
    user: "/user",
