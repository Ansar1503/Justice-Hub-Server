...
exports.AddSessionSummaryUsecase = void 0;
class AddSessionSummaryUsecase {
    _sessionRepo;
    ...
    async execute(input) {
        ...
        if (!updated)
            throw new Error("error updating sesison");
        return {
...
exports.AddSessionSummaryUsecase = AddSessionSummaryUsecase;
