...
exports.FetchLawyerDataUseCase = void 0;
class FetchLawyerDataUseCase {
    userRepo;
    lawyerRepo;
    lawyerDocRepo;
    lawyerVerificationRepo;
    constructor(userRepo, lawyerRepo, lawyerDocRepo, lawyerVerificationRepo) {
        this.userRepo = userRepo;
        this.lawyerRepo = lawyerRepo;
        this.lawyerDocRepo = lawyerDocRepo;
        this.lawyerVerificationRepo = lawyerVerificationRepo;
    }
    async execute(input) {
...
exports.FetchLawyerDataUseCase = FetchLawyerDataUseCase;
