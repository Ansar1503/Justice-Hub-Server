...
exports.UpdateCasetypeUsecase = void 0;
class UpdateCasetypeUsecase {
    caseTypeRepo;
    practiceAreaRepo;
    ...
    async execute(input) {
        ...
        if (!updatedCasetype)
            throw new Error("case type update failed");
        return {
...
exports.UpdateCasetypeUsecase = UpdateCasetypeUsecase;
