...
exports.BookAppointmentByWalletUsecase = void 0;
...
class BookAppointmentByWalletUsecase {
    _uow;
    _commissionSettingsRepo;
    constructor(_uow, _commissionSettingsRepo) {
        this._uow = _uow;
        ...
        return this._uow.startTransaction(async (uow) => {
            ...
            if (override && Object.keys(override).length > 0) {
                ...
                if (overrideDate.timeRanges.length > 0) {
                    ...
                    const newCase = Case_1.Case.create({
                        caseType: caseId,
                        clientId: client_id,
                        lawyerId: lawyer_id,
                        title: title,
...
exports.BookAppointmentByWalletUsecase = BookAppointmentByWalletUsecase;
