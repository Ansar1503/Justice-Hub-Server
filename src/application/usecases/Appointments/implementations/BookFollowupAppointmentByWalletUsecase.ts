...
import { IBookFollowupAppointmentByWalletUsecase } from "../IBookFollowupAppointmentByWalletUsecase";
  ...
  implements IBookFollowupAppointmentByWalletUsecase
{
  ...
  async execute(
    ...
    const { caseId, client_id, date, duration, lawyer_id, reason, timeSlot } =
      input;
