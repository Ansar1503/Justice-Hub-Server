...
//   //   payload: ChangeLawyerVerificationInnOutDTO
...
//   //   });
//   //   if (!updatedlawyer) {
//   //     throw new ValidationError("FAILED_TO_UPDATE_VERIFICATION_STATUS");
//   //   }
...
//     totalPage: number;
//   }> {
//     return await this.DisputesRepo.findReviewDisputes(paylaoad);
//   }
